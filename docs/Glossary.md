...
| **Technician**               | Agent that work in a maintenance. It can exist multiple to the same maintenance.                                               |
| **Supervisor**               | Agent that supervises the maintenance and the technicians working in it.                                                       |