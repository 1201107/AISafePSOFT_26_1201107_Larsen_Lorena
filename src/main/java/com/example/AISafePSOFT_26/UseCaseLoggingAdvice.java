...
public class UseCaseLoggingAdvice {
    private static final Logger LOGGER = LoggerFactory.getLogger(com.example.AISafePSOFT_26.UseCaseLoggingAdvice.class);

    /** Matches any class annotated with {@link UseCase}. */
    @Pointcut("within(@com.example.AISafePSOFT_26.UseCase *)")
    public void useCase() {
    }
